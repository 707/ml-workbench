...
class TestCallOpenrouterTimeout:
    ...
    def test_post_called_with_timeout(self):
        ...
        with patch("workbench.openrouter.requests.post", return_value=mock_resp) as mock_post:
...
class TestFetchModels:
    ...
    def test_returns_list(self):
        ...
        with patch("workbench.openrouter.requests.get", return_value=mock_resp):
            result = fetch_models()
    ...
    def test_calls_correct_url(self):
        from workbench.openrouter import OPENROUTER_MODELS_URL, fetch_models

        mock_resp = MagicMock()
        mock_resp.json.return_value = SAMPLE_MODELS_RESPONSE
        mock_resp.raise_for_status = MagicMock()

        with patch("workbench.openrouter.requests.get", return_value=mock_resp) as mock_get:
            fetch_models()
...
class TestRefreshFromOpenrouter:
    ...
    def test_updates_cache_with_live_data(self):
        from workbench.pricing import _clear_cache, _pricing_cache, refresh_from_openrouter
        ...
        with patch("workbench.openrouter.fetch_models", return_value=mock_models):
    ...
    def test_fallback_on_api_failure(self):
        from workbench.pricing import _clear_cache, get_pricing, refresh_from_openrouter

        _clear_cache()
        with patch("workbench.openrouter.fetch_models", side_effect=Exception("network error")):
            refresh_from_openrouter()
    ...
    def test_last_refreshed_updated(self):
        from workbench.pricing import _clear_cache, get_last_refreshed, refresh_from_openrouter
...
class TestGetPricingWithCache:
    ...
    def test_static_still_works(self):
        from workbench.pricing import _clear_cache, get_pricing
    ...
    def test_cached_model_returned(self):
        from workbench.pricing import _clear_cache, _pricing_cache, get_pricing
...
class TestAvailableModelsWithCache:
    ...
    def test_includes_static_models(self):
        from workbench.pricing import _clear_cache, available_models
    ...
    def test_includes_cached_models(self):
        from workbench.pricing import _clear_cache, _pricing_cache, available_models
