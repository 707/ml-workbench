...
### Completed
- Step 1: Added plotly>=5.18 dependency ✓
- Step 2: Failing tests for build_bubble_chart (7 tests) ✓
- Step 3: Implemented build_bubble_chart — pure function with risk colors, sqrt-scaled bubbles, hover templates ✓
- Step 4: Wired gr.Plot() into Analyze Text tab, _handle_dashboard returns 4-tuple ✓
- Step 5: Visual polish — explainer text, info hints, section headers ✓
- Code review: removed dead monthly_costs dict, aligned return order to eliminate wrapper ✓
- All 246 tests pass, 96% coverage on token_tax_ui.py
